...
var fs_1 = require("fs");
var fs_2 = require("fs");
var ImgResize_1 = __importDefault(require("./ImgResize"));
var city = (0, express_1.Router)();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!(cityName === undefined)) return [3 /*break*/, 1];
                return [2 /*return*/, res
                        .status(404)
                        .send('Not Found!! we can not found the city you have entered')];
            case 1:
                if (!(cityName === false)) return [3 /*break*/, 2];
                return [2 /*return*/, res
                        .status(404)
                        .send('sorry, The city name you have enterd not found')];
            case 2:
                if (!((0, fs_1.existsSync)(imageLoc) === false)) return [3 /*break*/, 3];
            ...
            case 4:
                ...
                return [4 /*yield*/, (0, ImgResize_1.default)(imageLoc, name, width, height, newLocation)];
            case 5:
                _a.sent();
                console.log(imageLoc);
                console.log(newLocation);
                res.sendFile("".concat(newLocation, "/").concat(name, "_").concat(width, "_").concat(height, ".png"));
                _a.label = 6;
            case 6:
                ;
                _a.label = 7;
